...
contract FlightSuretyApp {
    ...
    */
    ...
    /**
    * @dev Modifier that requires the airline to have deposited 10 Ether in order to participate
    */
    modifier isCallerParticipatingAirline()
    {
        require(flightSuretyData.isAirline(msg.sender), "Permission denied: Not a participating airline. Register and deposit 10 Ether.");
        _;
    }
    ...
    */
    ...
    function testIsBool(bool isTrue) external view requireIsOperational() returns(bool) {
        return isTrue;
    }
...
// region ORACLE MANAGEMENT
    ...
    struct ResponseInfo {
        ...
        mapping(uint8 => address[]) responses;          // Mapping key is the status code reported
                                                        ...
                                                        // the response of the majority of the oracles
    }
    ...
    */
    ...
    // Returns pseudo-random integer from 0-9
...
interface FlightSuretyData {
    ...
    function registerFlight(address airline, string calldata flight, uint256 departureTimestamp) external returns(bool);
